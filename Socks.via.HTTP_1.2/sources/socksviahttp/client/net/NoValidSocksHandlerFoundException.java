...
// Title :        NoValidSocksHandlerFoundException.java
// Version :      1.2
...
import socksviahttp.client.engine.SocksException;

public class NoValidSocksHandlerFoundException extends SocksException
{
  public NoValidSocksHandlerFoundException()
  {
    super();
  }

  public NoValidSocksHandlerFoundException(String message)
  {
    super(message);
  }
}
